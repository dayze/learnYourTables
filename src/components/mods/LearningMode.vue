<template>
  <div class="overlay anim-forward very-fast">
    ...
    <div class="grid">
      <div class="cell-12">
        <h1 class="margin-0 size-big margin-0-top borders-bottom borders-silver">The Learning Mode</h1>
        <h2 class="text-center margin-50-top medium wide uppercase weight-light">
